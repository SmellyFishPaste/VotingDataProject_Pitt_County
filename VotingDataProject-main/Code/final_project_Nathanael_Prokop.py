...
def plot_voter_distribution(district_files, voters_gdfs, school_type, output_prefix, output_folder):
    ...
    plt.suptitle(f"Pitt County Voter Distribution by {school_type}, by Nathanael Prokop (reggin23@students.ecu.edu)", fontsize=16)
    plt.savefig(output_folder / f"{output_prefix}_distribution_Nathanael_prokop.jpg")
